    ...
    <div className="flex flex-col flex-1 space-y-8 w-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-4 items-center">
          <select
            ...
            className="block w-48 px-3 py-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
          >
      ...
      {error ? (
        <div className="bg-red-50 p-4 rounded-md">
          <div className="flex">
            <div className="ml-3">
              <h2 className="text-sm font-medium text-red-800">Error loading courses</h2>
        ...
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
          <h2 className="mt-2 text-sm font-medium text-gray-900">No courses yet</h2>
