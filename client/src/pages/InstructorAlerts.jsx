      ...
      <div className="w-full">
        <div className="bg-red-50 p-4 rounded-md border border-red-100">
          <div className="flex">
            ...
            <div className="ml-3">
              <h2 className="text-sm font-medium text-red-800">Error loading alerts</h2>
    ...
    <div className="flex flex-col flex-1 space-y-8 w-full">
      ...
      {alerts.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200 shadow-sm">
          ...
          <h2 className="mt-2 text-sm font-medium text-gray-900">No inactive learners right now</h2>
